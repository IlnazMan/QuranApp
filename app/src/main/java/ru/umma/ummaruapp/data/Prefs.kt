...
class Prefs(private val context: Context) {
    ...
    fun saveLastAyah(ayahNumber: String, offset: Int) {
        _prefs.edit()
            .putString(KEY_AYAH, ayahNumber)
            .putInt(KEY_OFFSET, offset)
            .commit()
    }

    fun getLastAyah() = _prefs.getString(KEY_AYAH, null) to _prefs.getInt(KEY_OFFSET, 0)
}
